...
RC_NAME="action-allow-mirror-tls"
PRIORITY=1100

# =============================================
# 步驟 1：建立 Rule Collection Group Draft
# =============================================
...
# =============================================
# 步驟 2：在 Draft 中建立 Rule Collection
# =============================================
...
# winget 套件 Microsoft.Edge v147.0.3912.98 下載所需路徑（TLS Inspection）
az network firewall policy rule-collection-group draft collection rule add \
  --policy-name "$POLICY_NAME" \
  --resource-group "$RESOURCE_GROUP" \
  --rule-collection-group-name "$RCG_NAME" \
...
# =============================================
# 步驟 4：確認 Draft 內容後部署（手動執行）
# =============================================
# ⚠️ 以下指令會將 Draft 規則套用至正式環境，請確認內容無誤後再執行
#
# az network firewall policy rule-collection-group draft deploy \
#   --policy-name "$POLICY_NAME" \
#   --resource-group "$RESOURCE_GROUP" \
#   --rule-collection-group-name "$RCG_NAME"
