...
$PkgDir = "$DownloadDir\Microsoft\AIShell"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.AIShell v1.0.0-preview.8" -ForegroundColor White

$FilePath = "$PkgDir\AIShell-1.0.0-preview.8-win-x86.zip"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: AIShell-1.0.0-preview.8-win-x86.zip (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: AIShell-1.0.0-preview.8-win-x86.zip (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://github.com/PowerShell/AIShell/releases/download/v1.0.0-preview.8/AIShell-1.0.0-preview.8-win-x86.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: AIShell-1.0.0-preview.8-win-x86.zip" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\AIShell-1.0.0-preview.8-win-x64.zip"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: AIShell-1.0.0-preview.8-win-x64.zip (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: AIShell-1.0.0-preview.8-win-x64.zip (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://github.com/PowerShell/AIShell/releases/download/v1.0.0-preview.8/AIShell-1.0.0-preview.8-win-x64.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: AIShell-1.0.0-preview.8-win-x64.zip" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\AIShell-1.0.0-preview.8-win-arm64.zip"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: AIShell-1.0.0-preview.8-win-arm64.zip (arm64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: AIShell-1.0.0-preview.8-win-arm64.zip (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://github.com/PowerShell/AIShell/releases/download/v1.0.0-preview.8/AIShell-1.0.0-preview.8-win-arm64.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: AIShell-1.0.0-preview.8-win-arm64.zip" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.APM v0.11.0" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://github.com/microsoft/apm/releases/download/v0.11.0/apm-windows-x86_64.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\AmendmentAppWordService"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.AmendmentAppWordService v4.2.0.0" -ForegroundColor White

$FilePath = "$PkgDir\AmendmentAppWordServiceV4.2.Setup.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: AmendmentAppWordServiceV4.2.Setup.msi (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: AmendmentAppWordServiceV4.2.Setup.msi (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://amendmentservice.azurewebsites.net/assets/AmendmentAppWordServiceV4.2.Setup.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: AmendmentAppWordServiceV4.2.Setup.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.Azd v1.24.300" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://github.com/Azure/azure-dev/releases/download/azure-dev-cli_1.24.2/azd-windows-amd64.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\BotFrameworkComposer"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.BotFrameworkComposer v2.1.2" -ForegroundColor White

$FilePath = "$PkgDir\BotFramework-Composer-2.1.2-windows-setup.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: BotFramework-Composer-2.1.2-windows-setup.exe (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: BotFramework-Composer-2.1.2-windows-setup.exe (x64/user)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://github.com/microsoft/BotFramework-Composer/releases/download/v2.1.2/BotFramework-Composer-2.1.2-windows-setup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: BotFramework-Composer-2.1.2-windows-setup.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\BotFrameworkEmulator"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.BotFrameworkEmulator v4.15.1" -ForegroundColor White

$FilePath = "$PkgDir\BotFramework-Emulator-4.15.1-windows-setup.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: BotFramework-Emulator-4.15.1-windows-setup.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: BotFramework-Emulator-4.15.1-windows-setup.exe (x86/user)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://github.com/microsoft/BotFramework-Emulator/releases/download/v4.15.1/BotFramework-Emulator-4.15.1-windows-setup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: BotFramework-Emulator-4.15.1-windows-setup.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DirectAccessCTST"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DirectAccessCTST v1.4.4.0" -ForegroundColor White

$FilePath = "$PkgDir\DirectAccessClientTroubleshooter.zip"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: DirectAccessClientTroubleshooter.zip (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: DirectAccessClientTroubleshooter.zip (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/a/d/0/ad0ef574-fa76-430e-b122-ae0f36dba55e/DirectAccessClientTroubleshooter.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: DirectAccessClientTroubleshooter.zip" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DotNet\AspNetCore\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DotNet.AspNetCore.6 v6.0.36" -ForegroundColor White

$FilePath = "$PkgDir\aspnetcore-runtime-6.0.36-win-x64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: aspnetcore-runtime-6.0.36-win-x64.exe (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: aspnetcore-runtime-6.0.36-win-x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/6.0.36/aspnetcore-runtime-6.0.36-win-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: aspnetcore-runtime-6.0.36-win-x64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\aspnetcore-runtime-6.0.36-win-x86.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: aspnetcore-runtime-6.0.36-win-x86.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: aspnetcore-runtime-6.0.36-win-x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/6.0.36/aspnetcore-runtime-6.0.36-win-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: aspnetcore-runtime-6.0.36-win-x86.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DotNet\DesktopRuntime\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DotNet.DesktopRuntime.6 v6.0.36" -ForegroundColor White

$FilePath = "$PkgDir\windowsdesktop-runtime-6.0.36-win-x86.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: windowsdesktop-runtime-6.0.36-win-x86.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: windowsdesktop-runtime-6.0.36-win-x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/WindowsDesktop/6.0.36/windowsdesktop-runtime-6.0.36-win-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: windowsdesktop-runtime-6.0.36-win-x86.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\windowsdesktop-runtime-6.0.36-win-x64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: windowsdesktop-runtime-6.0.36-win-x64.exe (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: windowsdesktop-runtime-6.0.36-win-x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/WindowsDesktop/6.0.36/windowsdesktop-runtime-6.0.36-win-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: windowsdesktop-runtime-6.0.36-win-x64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\windowsdesktop-runtime-6.0.36-win-arm64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: windowsdesktop-runtime-6.0.36-win-arm64.exe (arm64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: windowsdesktop-runtime-6.0.36-win-arm64.exe (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/WindowsDesktop/6.0.36/windowsdesktop-runtime-6.0.36-win-arm64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: windowsdesktop-runtime-6.0.36-win-arm64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DotNet\Framework\DeveloperPack\4\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DotNet.Framework.DeveloperPack.4.6 v4.6.2" -ForegroundColor White

$FilePath = "$PkgDir\NDP462-DevPack-KB3151934-ENU.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: NDP462-DevPack-KB3151934-ENU.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: NDP462-DevPack-KB3151934-ENU.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/e/e/c/eec79116-8305-4bd0-aa83-27610987eec6/NDP462-DevPack-KB3151934-ENU.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: NDP462-DevPack-KB3151934-ENU.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DotNet\HostingBundle\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DotNet.HostingBundle.6 v6.0.36" -ForegroundColor White

$FilePath = "$PkgDir\dotnet-hosting-6.0.36-win.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-hosting-6.0.36-win.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-hosting-6.0.36-win.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/6.0.36/dotnet-hosting-6.0.36-win.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-hosting-6.0.36-win.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DotNet\Runtime\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DotNet.Runtime.6 v6.0.36" -ForegroundColor White

$FilePath = "$PkgDir\dotnet-runtime-6.0.36-win-arm64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-runtime-6.0.36-win-arm64.exe (arm64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-runtime-6.0.36-win-arm64.exe (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/Runtime/6.0.36/dotnet-runtime-6.0.36-win-arm64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-runtime-6.0.36-win-arm64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\dotnet-runtime-6.0.36-win-x64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-runtime-6.0.36-win-x64.exe (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-runtime-6.0.36-win-x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/Runtime/6.0.36/dotnet-runtime-6.0.36-win-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-runtime-6.0.36-win-x64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\dotnet-runtime-6.0.36-win-x86.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-runtime-6.0.36-win-x86.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-runtime-6.0.36-win-x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/Runtime/6.0.36/dotnet-runtime-6.0.36-win-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-runtime-6.0.36-win-x86.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\DotNet\SDK\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.DotNet.SDK.6 v6.0.428" -ForegroundColor White

$FilePath = "$PkgDir\dotnet-sdk-6.0.428-win-arm64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-sdk-6.0.428-win-arm64.exe (arm64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-sdk-6.0.428-win-arm64.exe (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/Sdk/6.0.428/dotnet-sdk-6.0.428-win-arm64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-sdk-6.0.428-win-arm64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\dotnet-sdk-6.0.428-win-x64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-sdk-6.0.428-win-x64.exe (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-sdk-6.0.428-win-x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/Sdk/6.0.428/dotnet-sdk-6.0.428-win-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-sdk-6.0.428-win-x64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\dotnet-sdk-6.0.428-win-x86.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: dotnet-sdk-6.0.428-win-x86.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: dotnet-sdk-6.0.428-win-x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://builds.dotnet.microsoft.com/dotnet/Sdk/6.0.428/dotnet-sdk-6.0.428-win-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: dotnet-sdk-6.0.428-win-x86.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.Edge v147.0.3912.86" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/ecf38857-d903-464d-8194-e0c53cf12d70/MicrosoftEdgeEnterpriseX86.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/2d48f894-08d6-4212-99bc-319200435457/MicrosoftEdgeEnterpriseX64.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/3affa9c5-86b9-4dc6-8a78-6332060dca2e/MicrosoftEdgeEnterpriseARM64.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.EdgeDriver v147.0.3912.86" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedgedriver.microsoft.com/147.0.3912.86/edgedriver_win32.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedgedriver.microsoft.com/147.0.3912.86/edgedriver_win64.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedgedriver.microsoft.com/147.0.3912.86/edgedriver_arm64.zip" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.EdgeWebView2Runtime v147.0.3912.86" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/a37c3727-d166-4729-8654-b217b3c37e44/MicrosoftEdgeWebView2RuntimeInstallerX86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/74dcb3ad-6bec-4212-bd0e-1f18ace9858a/MicrosoftEdgeWebView2RuntimeInstallerX64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/f15afe06-49b5-4a2b-875b-6ade667bbf07/MicrosoftEdgeWebView2RuntimeInstallerARM64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\FRSDiag"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.FRSDiag v1.7" -ForegroundColor White

$FilePath = "$PkgDir\frsdiag.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: frsdiag.msi (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: frsdiag.msi (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/4/c/5/4c5144f0-44cd-4a86-aca9-1cd5fdcde9ec/frsdiag.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: frsdiag.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\GameInput"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.GameInput v3.3.195.0" -ForegroundColor White

$FilePath = "$PkgDir\GameInputRedist.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: GameInputRedist.msi (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: GameInputRedist.msi (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://github.com/microsoftconnect/GameInput/releases/download/v3.3.195.0/GameInputRedist.msi" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: GameInputRedist.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.OneDrive v26.062.0402.0002" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://oneclient.sfx.ms/Win/Installers/26.062.0402.0002/OneDriveSetup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://oneclient.sfx.ms/Win/Installers/26.062.0402.0002/amd64/OneDriveSetup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://oneclient.sfx.ms/Win/Installers/26.062.0402.0002/arm64/OneDriveSetup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.OpenJDK.11 v11.0.30.7" -ForegroundColor White

$FilePath = "$PkgDir\microsoft-JDK-11.0.30-windows-x64.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: microsoft-JDK-11.0.30-windows-x64.msi (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: microsoft-JDK-11.0.30-windows-x64.msi (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/download-JDK/microsoft-JDK-11.0.30-windows-x64.msi#winget" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: microsoft-JDK-11.0.30-windows-x64.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\microsoft-JDK-11.0.30-windows-aarch64.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: microsoft-JDK-11.0.30-windows-aarch64.msi (arm64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: microsoft-JDK-11.0.30-windows-aarch64.msi (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/download-JDK/microsoft-JDK-11.0.30-windows-aarch64.msi#winget" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: microsoft-JDK-11.0.30-windows-aarch64.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.OpenJDK.25 v25.0.2.10" -ForegroundColor White

$FilePath = "$PkgDir\microsoft-JDK-25.0.2-windows-x64.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: microsoft-JDK-25.0.2-windows-x64.msi (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: microsoft-JDK-25.0.2-windows-x64.msi (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/download-JDK/microsoft-JDK-25.0.2-windows-x64.msi#winget" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: microsoft-JDK-25.0.2-windows-x64.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}

$FilePath = "$PkgDir\microsoft-JDK-25.0.2-windows-aarch64.msi"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: microsoft-JDK-25.0.2-windows-aarch64.msi (arm64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: microsoft-JDK-25.0.2-windows-aarch64.msi (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/download-JDK/microsoft-JDK-25.0.2-windows-aarch64.msi#winget" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: microsoft-JDK-25.0.2-windows-aarch64.msi" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.Teams v26072.521.4595.7966" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://installer.teams.static.microsoft/production-windows-x86/26072.521.4595.7966/MSTeams-x86.msix" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://installer.teams.static.microsoft/production-windows-x64/26072.521.4595.7966/MSTeams-x64.msix" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://installer.teams.static.microsoft/production-windows-arm64/26072.521.4595.7966/MSTeams-arm64.msix" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\VCRedist\2012\x64"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.VCRedist.2012.x64 v11.0.61030.0" -ForegroundColor White

$FilePath = "$PkgDir\vcredist_x64.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: vcredist_x64.exe (x64)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: vcredist_x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: vcredist_x64.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\VCRedist\2012\x86"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.VCRedist.2012.x86 v11.0.61030.0" -ForegroundColor White

$FilePath = "$PkgDir\vcredist_x86.exe"
if (Test-Path $FilePath) {
    Write-Host "   ⏭️  已存在: vcredist_x86.exe (x86)" -ForegroundColor DarkGray
    $Skipped++
} else {
    Write-Host "   ⬇️  下載中: vcredist_x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
        Write-Host "   ❌ 下載失敗: vcredist_x86.exe" -ForegroundColor Red
        $Failed++
        Remove-Item $FilePath -ErrorAction SilentlyContinue
    }
}
...
$PkgDir = "$DownloadDir\Microsoft\VCRedist\2013\x64"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.VCRedist.2013.x64 v12.0.40664.0" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: vcredist_x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.visualstudio.microsoft.com/download/pr/10912041/cee5d6bca2ddbcd039da727bf4acb48a/vcredist_x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\VCRedist\2013\x86"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.VCRedist.2013.x86 v12.0.40664.0" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: vcredist_x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://download.visualstudio.microsoft.com/download/pr/10912113/5da66ddebb0ad32ebd4b922fd82e8e25/vcredist_x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.WinAppCli v0.3.0" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://github.com/microsoft/winappCli/releases/download/v0.3.0/winappcli_x64.msix" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://github.com/microsoft/winappCli/releases/download/v0.3.0/winappcli_arm64.msix" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\WindowsAppRuntime\1\5"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.WindowsAppRuntime.1.5 v1.5.8" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.5/1.5.241107002/windowsappruntimeinstall-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.5/1.5.241107002/windowsappruntimeinstall-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.5/1.5.241107002/windowsappruntimeinstall-arm64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\WindowsAppRuntime\1\6"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.WindowsAppRuntime.1.6 v1.6.9" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: windowsappruntimeinstall-x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.6/1.6.250602001/windowsappruntimeinstall-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: windowsappruntimeinstall-x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.6/1.6.250602001/windowsappruntimeinstall-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: windowsappruntimeinstall-arm64.exe (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.6/1.6.250602001/windowsappruntimeinstall-arm64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.WindowsAppRuntime.1.8 v1.8.6" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: windowsappruntimeinstall-x86.exe (x86/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.8/1.8.260317003/windowsappruntimeinstall-x86.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: windowsappruntimeinstall-x64.exe (x64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.8/1.8.260317003/windowsappruntimeinstall-x64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
if (Test-Path $FilePath) {
    ...
    Write-Host "   ⬇️  下載中: windowsappruntimeinstall-arm64.exe (arm64/default)" -ForegroundColor Yellow
    try {
        Invoke-WebRequest -Uri "https://aka.ms/windowsappsdk/1.8/1.8.260317003/windowsappruntimeinstall-arm64.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\WindowsSDK\10\0\22000"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.WindowsSDK.10.0.22000 v10.0.22000.832" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/1/0/e/10e6da02-01f7-40d4-8942-b98b53b36cf9/windowssdk/winsdksetup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
...
$PkgDir = "$DownloadDir\Microsoft\WindowsWDK\10\0\22000"
New-Item -ItemType Directory -Path $PkgDir -Force | Out-Null
Write-Host "📦 Microsoft.WindowsWDK.10.0.22000 v10.1.22000.1" -ForegroundColor White
...
if (Test-Path $FilePath) {
    ...
    try {
        Invoke-WebRequest -Uri "https://download.microsoft.com/download/7/d/6/7d602355-8ae9-414c-ae36-109ece2aade6/wdk/wdksetup.exe" -OutFile $FilePath -UseBasicParsing
        $Size = (Get-Item $FilePath).Length / 1MB
        Write-Host ("   ✅ 完成: {0:N1} MB" -f $Size) -ForegroundColor Green
        $Total++
    } catch {
