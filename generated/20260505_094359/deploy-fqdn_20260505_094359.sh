...
rule_exists_and_matches "mirror-to-gh-copilot-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-githubdesktop-https" "desktop.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-gitlfs-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-cli-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-git-sizer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-aksdesktop-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-apm-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-asrtesttool-https" "demo.wd.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-accessdatabaseengine2016-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-accountlockoutstatus-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-administrativetemplates-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-advertisingeditor-https" "prod.editor.ads.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-appcontrolpolicywizard-https" "webapp-wdac-wizard.azurewebsites.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-appinstaller-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-appinstallerfilebuilder-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-applockerpolicyconverter-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-applicationinspector-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-aspire-https" "ci.dot.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azd-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-adconnectsyncdocumenter-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-azcopy-10-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-artifactsigningclienttools-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-auth-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-az-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-aztfexport-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-batchexplorer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-cloudhsm-clientsdk-https" "github.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-connectedmachineagent-https" "gbl.his.arc.azure.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-cosmosemulator-https" "cdbemulator-dmhwaeevbhd3e9f8.b02.azurefd.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-datacli-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-datastudio-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-functionscoretools-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-guestproxyagent-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-iotexplorer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-kubelogin-https" "packages.aks.azure.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-quickreview-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-storageexplorer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-templateanalyzer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-trustedsigningclienttools-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azurecli-https" "azcliprod.blob.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azuremonitoragent-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azurevpnclient-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-btp-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-bicep-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-clrtypessqlserver-2019-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-certifiedtoolazurevm-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-cmdpalazureextension-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-cmdpalgithubextension-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dsc-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dtrace-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-datamigrationassistant-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-datatools-integrationservices-https" "ssis.gallerycdn.vsassets.io" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-debugdiag-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-defenderforcloud-cli-https" "cli.dfd.security.azure.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dependencyagent-https" "da-release-ehacb6gnczcma8hc.b01.azurefd.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-deploymenttoolkit-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-devskim-cli-dotnettool-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-devskim-cli-librarypackage-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directx-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directxtex-texassemble-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directxtex-texconv-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directxtex-texdiag-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-diskspd-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-aspnetcore-10-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-aspnetcore-8-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-aspnetcore-9-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-desktopruntime-10-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-desktopruntime-8-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-desktopruntime-9-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-framework-developerpack_4-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-framework-runtime-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-hostingbundle-10-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-hostingbundle-8-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-hostingbundle-9-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-native-runtime-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-repairtool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-runtime-10-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-runtime-8-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-runtime-9-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-sdk-10-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-sdk-8-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-sdk-9-https" "builds.dotnet.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-uninstalltool-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-dotnet-ef-https" "globalcdn.nuget.org" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-edge-https" "msedge.sf.dl.delivery.mp.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-edgedriver-https" "msedgedriver.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-edgewebview2runtime-https" "msedge.sf.dl.delivery.mp.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-edit-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-enterprisestateclassify-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-eventlogexpert-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-fslogix-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-foundrylocal-https" "foundry.onnxruntime.ai" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-fuzzylookupaddexcel-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-garnet-dn8-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-garnet-dn9-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-git-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-globalsecureaccessclient-https" "download.msappproxy.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-hidtools-waratah-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-hwpconverter-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-applicationrequestrouting-https" "download.microsoft.com go.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-compression-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-servicemonitor-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-urlrewrite-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iismanagerremoteadministration-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-idfix-https" "github.com raw.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-integrationruntime-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-intunewslplugin-https" "github.com raw.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ironpython-3-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-kanagawa-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-laps-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-lightgbm-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-lingeringobjectliquidator-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-logcheetah-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-logparser-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-m365agentsplayground-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mfcmapi-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-midi-featureenablementchecker-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-midi-sdk-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mitt-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msix-toolkit-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msixcore-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msixpackagingtool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mutt-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-malicioussoftwareremovaltool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mediacreationtool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mousewithoutborders-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mouseandkeyboardcenter-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ntttcp-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-nuget-https" "dist.nuget.org" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-oscdimg-https" "msdl.microsoft.com vsblobprodscussu5shard61.blob.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-osconfig-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-office-https" "officecdn.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-officedeploymenttool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-onedrive-https" "oneclient.sfx.ms" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-onelakefileexplorer-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-onenotediagnostics-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openapi-hidi-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openapi-kiota-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openclglvulkancompatibilitypack-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-11-https" "aka.ms download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-17-https" "aka.ms download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-21-https" "aka.ms download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-25-https" "aka.ms download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-pict-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-pix-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-pave-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-perfview-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerappscli-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerautomatedesktop-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerautomateprocessmining-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerbi-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerbireportbuilder-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerbireportserver-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powershell-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powertoys-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-printmetadatatroubleshooter-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-profileexplorer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-projecttelescope-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-promptflow-https" "promptflowartifact.blob.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-purviewinformationprotection-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-rmsclient-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-remotedesktopclient-https" "res.cdn.office.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-remotedesktopmmrservice-https" "intstreamreleases.z22.web.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-remotehelp-https" "catalog.s.download.windowsupdate.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-reportbuilder-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sbomtool-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2019-developer-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2019-express-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2022-developer-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2022-express-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2025-developer-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2025-express-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-oledbdriver-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-rmlutilities-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlservermanagementstudio-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-saracmd-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-safetyscanner-https" "definitionupdates.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-screenrecorder-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-securitycompliancetoolkit-lgpo-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-securitycompliancetoolkit-policyanalyzer-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-securitycompliancetoolkit-setobjectsecurity-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-servicefabricruntime-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-servicefabricsdk-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-setupdiag-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-smartdump-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlpackage-https" "download.microsoft.com go.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlcmd-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-surfaceapp-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-surfacehubrecoverytool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-symcryptunittest-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-autologon-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-autoruns-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-bginfo-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-ctrl2cap-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-debugview-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-desktops-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-findlinks-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-handle-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-movefile-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-pendmoves-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-processexplorer-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-processmonitor-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-rammap-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-rdcman-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-regjump-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-sdelete-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-sigcheck-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-strings-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-sysmon-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-tcpview-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-vmmap-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-whois-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-zoomit-https" "download.sysinternals.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-teammate-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-teams-https" "installer.teams.static.microsoft" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-teamstxndi-https" "teams.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-timetraveldebugging-https" "windbg.download.prss.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-tokenizer-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ui-xaml-2-7-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ui-xaml-2-8-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-updateassistant-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vclibs-14-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vclibs-desktop-14-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vcredist-2015+-arm64-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vcredist-2015+-x64-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vcredist-2015+-x86-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vsdotnetlogcollect-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vsixbootstrapper-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vstor-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visioviewer-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-buildtools-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-enterprise-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-onecoremsvsmon-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-professional-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-remotetools-https" "download.visualstudio.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-configfinder-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-extensions-typescript-https" "typescriptteam.gallerycdn.vsassets.io" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-locator-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudiocode-https" "vscode.download.prss.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualtruetype-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-wsl-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-wassette-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-webdeploy-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-win32contentpreptool-https" "codeload.github.com github.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-winappcli-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windbg-https" "windbg.download.prss.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsadk-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsadmincenter-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsapp-https" "res.cdn.office.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsappruntime-1-7-https" "aka.ms download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsappruntime-1-8-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsapplicationdriver-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsbusestracing-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowscloudioprotectiondriver-https" "res-1.cdn.office.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsdevicerecoverytool-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsinstallationassistant-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsmidiservicessdk-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowspchealthcheck-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowssdk-10-0-22621-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowssdk-10-0-26100-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowssdk-10-0-28000-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsterminal-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsvirtualdesktopagent-https" "go.microsoft.com query.prod.cms.rt.microsoft.com res.cdn.office.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsvirtualdesktopbootloader-https" "query.prod.cms.rt.microsoft.com res.cdn.office.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowswdk-10-0-22621-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowswdk-10-0-26100-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-wingetcreate-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-xmlnotepad-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-bitsmanager-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ebpfforwindows-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-err-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-etl2pcapng-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msodbcsql-17-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msodbcsql-18-https" "download.microsoft.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-quicreach-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-winfile-https" "github.com objects.githubusercontent.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-telerik-fiddler-classic-https" "downloads.getfiddler.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wiresharkfoundation-stratoshark-https" "1.na.dl.wireshark.org" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wiresharkfoundation-wireshark-https" "2.na.dl.wireshark.org" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-20-04-https" "aka.ms wslstorestorage.blob.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-22-04-https" "aka.ms wslstorestorage.blob.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-24-04-https" "cdimages.ubuntu.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-26-04-https" "cdimages.ubuntu.com" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
