...
rule_exists_and_matches "mirror-to-winget-infra-https" "cdn.winget.microsoft.com winget.azureedge.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
...
rule_exists_and_matches "mirror-to-gh-copilot-https" "github.com/github/copilot-cli/releases/download/*/copilot-win32-arm64.zip github.com/github/copilot-cli/releases/download/*/copilot-win32-x64.zip objects.githubusercontent.com/github-production-release-asset-2e65be/585860664/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-gitlfs-https" "github.com/git-lfs/git-lfs/releases/download/*/git-lfs-windows-* objects.githubusercontent.com/github-production-release-asset-2e65be/13021798/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-cli-https" "github.com/cli/cli/releases/download/*/gh_* objects.githubusercontent.com/github-production-release-asset-2e65be/212613049/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-gh-git-sizer-https" "github.com/github/git-sizer/releases/download/*/git-sizer-* objects.githubusercontent.com/github-production-release-asset-2e65be/119228008/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-aksdesktop-https" "github.com/Azure/aks-desktop/releases/download/*/aks-desktop-* objects.githubusercontent.com/github-production-release-asset-2e65be/1098474573/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-apm-https" "github.com/microsoft/apm/releases/download/*/apm-windows-x86_64.zip objects.githubusercontent.com/github-production-release-asset-2e65be/1059472549/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-asrtesttool-https" "demo.wd.microsoft.com/Content/ASRtool.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-accessdatabaseengine2016-https" "download.microsoft.com/download/3/5/c/*/accessdatabaseengine.exe download.microsoft.com/download/3/5/c/*/accessdatabaseengine_X64.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-accountlockoutstatus-https" "download.microsoft.com/download/c/0/4/*/lockoutstatus.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-administrativetemplates-https" "download.microsoft.com/download/*/Administrative%20Templates%20(admx)%20for%20Windows%2011%20Sep%202025%20Update.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-advertisingeditor-https" "prod.editor.ads.microsoft.com/download/production-pc/c/MicrosoftAdvertisingEditor.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-appcontrolpolicywizard-https" "webapp-wdac-wizard.azurewebsites.net/packages/WDACWizard_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-appinstaller-https" "github.com/microsoft/winget-cli/releases/download/*/Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle objects.githubusercontent.com/github-production-release-asset-2e65be/197275130/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-appinstallerfilebuilder-https" "github.com/microsoft/MSIX-Toolkit/releases/download/1.4/AppInstallerFileBuilder_* objects.githubusercontent.com/github-production-release-asset-2e65be/164953868/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-applockerpolicyconverter-https" "github.com/MicrosoftDocs/WDAC-Toolkit/releases/download/*/AppLockerPolicyConverter.zip objects.githubusercontent.com/github-production-release-asset-2e65be/222558613/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-applicationinspector-https" "github.com/microsoft/ApplicationInspector/releases/download/*/ApplicationInspector_win_* objects.githubusercontent.com/github-production-release-asset-2e65be/213480514/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-aspire-https" "ci.dot.net/public/aspire/*/aspire-cli-win-arm64-* ci.dot.net/public/aspire/*/aspire-cli-win-x64-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azd-https" "github.com/Azure/azure-dev/releases/download/azure-dev-cli_*/azd-windows-amd64.msi objects.githubusercontent.com/github-production-release-asset-2e65be/510889311/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-adconnectsyncdocumenter-https" "github.com/microsoft/AADConnectConfigDocumenter/releases/download/*/AzureADConnectSyncDocumenter.zip objects.githubusercontent.com/github-production-release-asset-2e65be/57305206/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-artifactsigningclienttools-https" "download.microsoft.com/download/*/ArtifactSigningClientTools.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-auth-https" "github.com/AzureAD/microsoft-authentication-cli/releases/download/*/azureauth-* objects.githubusercontent.com/github-production-release-asset-2e65be/463357839/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-az-https" "github.com/Azure/azure-powershell/releases/download/*/Az-Cmdlets-* objects.githubusercontent.com/github-production-release-asset-2e65be/23891194/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-aztfexport-https" "github.com/Azure/aztfexport/releases/download/*/aztfexport_* objects.githubusercontent.com/github-production-release-asset-2e65be/395943715/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-batchexplorer-https" "github.com/Azure/BatchExplorer/releases/download/*/BatchExplorer.Setup.* objects.githubusercontent.com/github-production-release-asset-2e65be/75422296/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-cloudhsm-clientsdk-https" "github.com/microsoft/MicrosoftAzureCloudHSM/releases/download/AzureCloudHSM-ClientSDK-*/AzureCloudHSM-ClientSDK-Windows-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-connectedmachineagent-https" "gbl.his.arc.azure.com/azcmagent/1.63/AzureConnectedMachineAgent.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-cosmosemulator-https" "cdbemulator-dmhwaeevbhd3e9f8.b02.azurefd.net/msi/pipeline/azure-cosmosdb-emulator-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-datacli-https" "download.microsoft.com/download/f/f/f/*/azdata-cli-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-iotexplorer-https" "github.com/Azure/azure-iot-explorer/releases/download/*/Azure.IoT.Explorer.Preview.* objects.githubusercontent.com/github-production-release-asset-2e65be/198303925/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-kubelogin-https" "packages.aks.azure.com/dalec-packages/kubelogin/*/windows/amd64/kubelogin_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-quickreview-https" "github.com/Azure/azqr/releases/download/v.*/azqr-win-amd64.zip objects.githubusercontent.com/github-production-release-asset-2e65be/552832415/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azure-trustedsigningclienttools-https" "download.microsoft.com/download/*/TrustedSigningClientTools.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azurecli-https" "azcliprod.blob.core.windows.net/msi/azure-cli-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azuremonitoragent-https" "download.microsoft.com/download/*/AzureMonitorAgentClientSetup.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-azurevpnclient-https" "download.microsoft.com/download/*/AzVpnAppx_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-btp-https" "download.microsoft.com/download/e/e/e/*/BluetoothTestPlatformPack-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-clrtypessqlserver-2019-https" "download.microsoft.com/download/d/d/1/*/SQLSysClrTypes.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-certifiedtoolazurevm-https" "download.microsoft.com/download/a/f/1/*/Certification%20Test%20Tool%201.6%20for%20Azure%20Certified.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-cmdpalazureextension-https" "github.com/microsoft/CmdPalAzureExtension/releases/download/*/AzureExtension_release_* objects.githubusercontent.com/github-production-release-asset-2e65be/924852317/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-cmdpalgithubextension-https" "github.com/microsoft/CmdPalGitHubExtension/releases/download/*/GitHubExtension_release_* objects.githubusercontent.com/github-production-release-asset-2e65be/914051042/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dsc-https" "github.com/PowerShell/DSC/releases/download/*/DSC-* objects.githubusercontent.com/github-production-release-asset-2e65be/572227672/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dtrace-https" "download.microsoft.com/download/7/9/d/*/DTrace.amd64.msi download.microsoft.com/download/7/9/d/*/DTrace.arm64.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-datamigrationassistant-https" "download.microsoft.com/download/c/6/3/*/DataMigrationAssistant.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-datatools-integrationservices-https" "ssis.gallerycdn.vsassets.io/extensions/ssis/microsoftdatatoolsintegrationservices/*/Microsoft.DataTools.IntegrationServices.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-debugdiag-https" "download.microsoft.com/download/9/3/a/*/DebugDiagx64.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-defenderforcloud-cli-https" "cli.dfd.security.azure.com/public/latest/Defender_win-arm64.exe cli.dfd.security.azure.com/public/latest/Defender_win-x64.exe cli.dfd.security.azure.com/public/latest/Defender_win-x86.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dependencyagent-https" "da-release-ehacb6gnczcma8hc.b01.azurefd.net/public/InstallDependencyAgent-Windows.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-deploymenttoolkit-https" "download.microsoft.com/download/3/3/9/*/MicrosoftDeploymentToolkit_x64.msi download.microsoft.com/download/3/3/9/*/MicrosoftDeploymentToolkit_x86.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-devskim-cli-dotnettool-https" "github.com/microsoft/DevSkim/releases/download/*/DevSkim_CLI_netcoreapp_* objects.githubusercontent.com/github-production-release-asset-2e65be/64857273/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-devskim-cli-librarypackage-https" "github.com/microsoft/DevSkim/releases/download/*/DevSkim_CLI_win_* objects.githubusercontent.com/github-production-release-asset-2e65be/64857273/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directx-https" "download.microsoft.com/download/1/7/1/*/dxwebsetup.exe download.microsoft.com/download/c/c/2/*/UAPSignedBinary_Microsoft.DirectX.x64.appx download.microsoft.com/download/c/c/2/*/UAPSignedBinary_Microsoft.DirectX.x86.appx" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directxtex-texconv-https" "github.com/microsoft/DirectXTex/releases/download/mar2026/texconv.exe github.com/microsoft/DirectXTex/releases/download/mar2026/texconv_arm64.exe objects.githubusercontent.com/github-production-release-asset-2e65be/33688642/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-directxtex-texdiag-https" "github.com/microsoft/DirectXTex/releases/download/mar2026/texdiag.exe github.com/microsoft/DirectXTex/releases/download/mar2026/texdiag_arm64.exe objects.githubusercontent.com/github-production-release-asset-2e65be/33688642/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-diskspd-https" "github.com/microsoft/diskspd/releases/download/*.2/DiskSpd.ZIP objects.githubusercontent.com/github-production-release-asset-2e65be/23956428/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-aspnetcore-10-https" "builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/*/aspnetcore-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-aspnetcore-8-https" "builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/*/aspnetcore-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-aspnetcore-9-https" "builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/*/aspnetcore-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-desktopruntime-10-https" "builds.dotnet.microsoft.com/dotnet/WindowsDesktop/*/windowsdesktop-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-desktopruntime-8-https" "builds.dotnet.microsoft.com/dotnet/WindowsDesktop/*/windowsdesktop-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-desktopruntime-9-https" "builds.dotnet.microsoft.com/dotnet/WindowsDesktop/*/windowsdesktop-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-framework-developerpack_4-https" "download.microsoft.com/download/8/1/8/*/NDP481-DevPack-ENU.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-framework-runtime-https" "download.microsoft.com/download/4/b/2/*/NDP481-x86-x64-AllOS-ENU.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-hostingbundle-10-https" "builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/*/dotnet-hosting-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-hostingbundle-8-https" "builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/*/dotnet-hosting-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-hostingbundle-9-https" "builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/*/dotnet-hosting-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-native-runtime-https" "github.com/microsoft/busiotools/releases/download/*/Dependencies.zip objects.githubusercontent.com/github-production-release-asset-2e65be/68876256/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-repairtool-https" "download.microsoft.com/download/2/b/d/*/NetFxRepairTool.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-runtime-10-https" "builds.dotnet.microsoft.com/dotnet/Runtime/*/dotnet-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-runtime-8-https" "builds.dotnet.microsoft.com/dotnet/Runtime/*/dotnet-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-runtime-9-https" "builds.dotnet.microsoft.com/dotnet/Runtime/*/dotnet-runtime-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-sdk-10-https" "builds.dotnet.microsoft.com/dotnet/Sdk/*/dotnet-sdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-sdk-8-https" "builds.dotnet.microsoft.com/dotnet/Sdk/*/dotnet-sdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-sdk-9-https" "builds.dotnet.microsoft.com/dotnet/Sdk/*/dotnet-sdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-uninstalltool-https" "github.com/dotnet/cli-lab/releases/download/*/dotnet-core-uninstall.msi objects.githubusercontent.com/github-production-release-asset-2e65be/189080814/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-dotnet-dotnet-ef-https" "globalcdn.nuget.org/packages/dotnet-ef.*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-edgedriver-https" "msedgedriver.microsoft.com/*/edgedriver_arm64.zip msedgedriver.microsoft.com/*/edgedriver_win32.zip msedgedriver.microsoft.com/*/edgedriver_win64.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-edit-https" "github.com/microsoft/edit/releases/download/*/edit-* objects.githubusercontent.com/github-production-release-asset-2e65be/952719663/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-enterprisestateclassify-https" "github.com/microsoft/EnterpriseStateClassify/releases/download/*.0/EnterpriseStateClassify.exe objects.githubusercontent.com/github-production-release-asset-2e65be/249860119/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-eventlogexpert-https" "github.com/microsoft/EventLogExpert/releases/download/*/EventLogExpert_* objects.githubusercontent.com/github-production-release-asset-2e65be/550617953/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-fslogix-https" "download.microsoft.com/download/*/FSLogix_26.01_CU1.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-foundrylocal-https" "foundry.onnxruntime.ai/FoundryLocal-arm64-* foundry.onnxruntime.ai/FoundryLocal-x64-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-fuzzylookupaddexcel-https" "download.microsoft.com/download/1/9/8/*/Setup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-garnet-dn8-https" "github.com/microsoft/garnet/releases/download/*/win-arm64-based-readytorun.zip github.com/microsoft/garnet/releases/download/*/win-x64-based-readytorun.zip objects.githubusercontent.com/github-production-release-asset-2e65be/681372871/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-garnet-dn9-https" "github.com/microsoft/garnet/releases/download/*/win-arm64-based-readytorun.zip github.com/microsoft/garnet/releases/download/*/win-x64-based-readytorun.zip objects.githubusercontent.com/github-production-release-asset-2e65be/681372871/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-git-https" "github.com/microsoft/git/releases/download/*/Git-* objects.githubusercontent.com/github-production-release-asset-2e65be/79856983/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-globalsecureaccessclient-https" "download.msappproxy.net/Subscription/*/Connector/GlobalSecureAccessClientArm64Installer" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-hidtools-waratah-https" "github.com/microsoft/hidtools/releases/download/Waratah-*.90/Waratah-Published.zip objects.githubusercontent.com/github-production-release-asset-2e65be/434452395/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-applicationrequestrouting-https" "download.microsoft.com/download/5/3/2/*/requestRouter_x86.msi download.microsoft.com/download/E/9/8/*/requestRouter_amd64.msi go.microsoft.com/fwlink/" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-compression-https" "download.microsoft.com/download/6/1/C/*/iiscompression_amd64.msi download.microsoft.com/download/6/1/C/*/iiscompression_x86.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-servicemonitor-https" "github.com/microsoft/IIS.ServiceMonitor/releases/download/*/ServiceMonitor.exe objects.githubusercontent.com/github-production-release-asset-2e65be/97153472/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iis-urlrewrite-https" "download.microsoft.com/download/1/2/8/*/rewrite_amd64_en-US.msi download.microsoft.com/download/D/8/1/*/rewrite_x86_en-US.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-iismanagerremoteadministration-https" "download.microsoft.com/download/2/4/3/*/inetmgr_amd64_en-US.msi download.microsoft.com/download/2/4/3/*/inetmgr_x86_en-US.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-idfix-https" "github.com/microsoft/idfix/raw/refs/heads/master/MSIs/IdFix.Setup.* raw.githubusercontent.com/microsoft/idfix/refs/heads/master/MSIs/IdFix.Setup.*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-integrationruntime-https" "download.microsoft.com/download/e/4/7/*/IntegrationRuntime_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ironpython-3-https" "github.com/IronLanguages/ironpython3/releases/download/*/IronPython-* objects.githubusercontent.com/github-production-release-asset-2e65be/17266066/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-kanagawa-https" "github.com/microsoft/kanagawa/releases/download/*/kanagawa-* objects.githubusercontent.com/github-production-release-asset-2e65be/1054333720/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-laps-https" "download.microsoft.com/download/C/7/A/*/LAPS.arm64.msi download.microsoft.com/download/C/7/A/*/LAPS.x64.msi download.microsoft.com/download/C/7/A/*/LAPS.x86.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-lightgbm-https" "github.com/lightgbm-org/LightGBM/releases/download/*/lightgbm.exe objects.githubusercontent.com/github-production-release-asset-2e65be/64991887/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-lingeringobjectliquidator-https" "download.microsoft.com/download/b/a/a/*/LingeringObjectLiquidatorInstaller.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-logcheetah-https" "github.com/microsoft/LogCheetah/releases/download/*/LogCheetah-Windows.zip objects.githubusercontent.com/github-production-release-asset-2e65be/787493746/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-logparser-https" "download.microsoft.com/download/f/f/1/*/LogParser.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-m365agentsplayground-https" "github.com/OfficeDev/microsoft-365-agents-toolkit/releases/download/microsoft-365-agents-playground@*/agentsplayground-win32-x64.zip objects.githubusercontent.com/github-production-release-asset-2e65be/348248652/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mfcmapi-https" "github.com/microsoft/mfcmapi/releases/download/*/MFCMAPI.exe.* github.com/microsoft/mfcmapi/releases/download/*/MFCMAPI.x64.exe.* objects.githubusercontent.com/github-production-release-asset-2e65be/70842621/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-midi-sdk-https" "github.com/microsoft/MIDI/releases/download/rc-3/Windows.MIDI.Services.SDK.Runtime.and.Tools.* objects.githubusercontent.com/github-production-release-asset-2e65be/495959471/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mitt-https" "download.microsoft.com/download/7/7/0/*/MITT.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msix-toolkit-https" "github.com/microsoft/MSIX-Toolkit/releases/download/1.4/MSIX-Toolkit.x64.zip github.com/microsoft/MSIX-Toolkit/releases/download/1.4/MSIX-Toolkit.x86.zip objects.githubusercontent.com/github-production-release-asset-2e65be/164953868/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-msixpackagingtool-https" "download.microsoft.com/download/e/2/e/*/MSIXPackagingtool*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mutt-https" "download.microsoft.com/download/*/MUTTPackage-3_0_0.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-malicioussoftwareremovaltool-https" "download.microsoft.com/download/2/c/5/*/Windows-KB890830-x64-V2/c/5/*/Windows-KB890830-x64-V5.139.exe download.microsoft.com/download/4/a/a/*/Windows-KB890830-V5.139.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mediacreationtool-https" "download.microsoft.com/download/*/MediaCreationTool.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-mousewithoutborders-https" "download.microsoft.com/download/6/5/8/*/MouseWithoutBordersSetup.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-ntttcp-https" "github.com/microsoft/ntttcp/releases/download/*.40/ntttcp.exe github.com/microsoft/ntttcp/releases/download/*.40/ntttcp_arm64.exe objects.githubusercontent.com/github-production-release-asset-2e65be/334283455/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-nuget-https" "dist.nuget.org/win-x86-commandline/*/nuget.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-oscdimg-https" "msdl.microsoft.com/download/symbols/oscdimg.exe/*/oscdimg.exe vsblobprodscussu5shard61.blob.core.windows.net/b-4712e0edc5a240eabf23330d7df68e77/9C917C34817C51DD18545A26D8E0498CA3E8ED9202FD9E63B698D4506992144400.blob" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-osconfig-https" "github.com/microsoft/osconfig/releases/download/*/Microsoft.OSConfig-* github.com/microsoft/osconfig/releases/download/*/oscfg-* objects.githubusercontent.com/github-production-release-asset-2e65be/852406378/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-office-https" "officecdn.microsoft.com/pr/wsus/setup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-officedeploymenttool-https" "download.microsoft.com/download/*/officedeploymenttool_19929-20062.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-onedrive-https" "oneclient.sfx.ms/Win/Installers/*/OneDriveSetup.exe oneclient.sfx.ms/Win/Installers/*/amd64/OneDriveSetup.exe oneclient.sfx.ms/Win/Installers/*/arm64/OneDriveSetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-onelakefileexplorer-https" "download.microsoft.com/download/*/OneLake_PuPr_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-onenotediagnostics-https" "download.microsoft.com/download/9/a/7/*/onenotediagnosticsinstaller.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openapi-hidi-https" "github.com/microsoft/OpenAPI.NET/releases/download/*/Microsoft.OpenApi.Hidi.exe objects.githubusercontent.com/github-production-release-asset-2e65be/97175798/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openclglvulkancompatibilitypack-https" "github.com/microsoft/OpenCLOn12/releases/download/*/Universal_D3DMappingLayers_* objects.githubusercontent.com/github-production-release-asset-2e65be/268860553/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-11-https" "aka.ms/download-JDK/microsoft-JDK-* download.visualstudio.microsoft.com/download/pr/*/microsoft-jdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-17-https" "aka.ms/download-JDK/microsoft-JDK-* download.visualstudio.microsoft.com/download/pr/*/microsoft-jdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-21-https" "aka.ms/download-JDK/microsoft-JDK-* download.visualstudio.microsoft.com/download/pr/*/microsoft-jdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-openjdk-25-https" "aka.ms/download-JDK/microsoft-JDK-* download.visualstudio.microsoft.com/download/pr/*/microsoft-jdk-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-pict-https" "github.com/microsoft/pict/releases/download/*/pict.exe objects.githubusercontent.com/github-production-release-asset-2e65be/44393232/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-pix-https" "download.microsoft.com/download/*/PIX-2603.25-Installer-ARM64.exe download.microsoft.com/download/*/PIX-2603.25-Installer-x64.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-pave-https" "github.com/microsoft/pave/releases/download/*/pave-aarch64-pc-windows-msvc.zip github.com/microsoft/pave/releases/download/*/pave-x86_64-pc-windows-msvc.zip objects.githubusercontent.com/github-production-release-asset-2e65be/1199983142/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-perfview-https" "github.com/microsoft/perfview/releases/download/*/PerfView.exe objects.githubusercontent.com/github-production-release-asset-2e65be/33010673/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerappscli-https" "download.microsoft.com/download/D/B/E/*/powerapps-cli-1.0.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerautomatedesktop-https" "download.microsoft.com/download/*/Setup.Microsoft.PowerAutomate.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerautomateprocessmining-https" "download.microsoft.com/download/*/PowerAutomateProcessMining_8wekyb3d8bbwe.msixbundle" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerbi-https" "download.microsoft.com/download/8/8/0/*/PBIDesktopSetup-2026-04_x64.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerbireportbuilder-https" "download.microsoft.com/download/a/2/e/*/PowerBIReportBuilder.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powerbireportserver-https" "download.microsoft.com/download/2/7/3/*/PowerBIReportServer.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powershell-https" "github.com/PowerShell/PowerShell/releases/download/*/PowerShell-* objects.githubusercontent.com/github-production-release-asset-2e65be/49609581/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-powertoys-https" "github.com/microsoft/PowerToys/releases/download/*/PowerToysSetup-* github.com/microsoft/PowerToys/releases/download/*/PowerToysUserSetup-* objects.githubusercontent.com/github-production-release-asset-2e65be/184456251/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-profileexplorer-https" "github.com/microsoft/profile-explorer/releases/download/*/profile_explorer_installer_* objects.githubusercontent.com/github-production-release-asset-2e65be/842089156/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-promptflow-https" "promptflowartifact.blob.core.windows.net/msi-installer/promptflow-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-purviewinformationprotection-https" "download.microsoft.com/download/*/PurviewInfoProtection.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-rmsclient-https" "download.microsoft.com/download/3/c/f/*/setup_msipc_x64.exe download.microsoft.com/download/3/c/f/*/setup_msipc_x86.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-remotedesktopclient-https" "res.cdn.office.net/remote-desktop-windows-client/*/RemoteDesktop_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-remotedesktopmmrservice-https" "intstreamreleases.z22.web.core.windows.net/MsMMRHostInstaller_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-remotehelp-https" "catalog.s.download.windowsupdate.com/c/msdownload/update/software/updt/2025/03/remotehelpinstaller_bd142b4c833c024a512ed124a1f9058461e18cab.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-reportbuilder-https" "download.microsoft.com/download/5/E/B/*/ReportBuilder.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sbomtool-https" "github.com/microsoft/sbom-tool/releases/download/*/sbom-tool-win-x64.exe objects.githubusercontent.com/github-production-release-asset-2e65be/498824328/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2019-developer-https" "download.microsoft.com/download/d/a/2/*/SQL2019-SSEI-Dev.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2019-express-https" "download.microsoft.com/download/7/f/8/*/SQL2019-SSEI-Expr.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2022-developer-https" "download.microsoft.com/download/c/c/9/*/SQL2022-SSEI-Dev.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2022-express-https" "download.microsoft.com/download/5/1/4/*/SQL2022-SSEI-Expr.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2025-developer-https" "download.microsoft.com/download/*/SQL2025-SSEI-StdDev.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-2025-express-https" "download.microsoft.com/download/*/SQL2025-SSEI-Expr.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlserver-rmlutilities-https" "download.microsoft.com/download/6/5/8/*/RMLSetup.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlservermanagementstudio-https" "download.microsoft.com/download/*/SSMS-Setup-CHS.exe download.microsoft.com/download/*/SSMS-Setup-CHT.exe download.microsoft.com/download/*/SSMS-Setup-DEU.exe download.microsoft.com/download/*/SSMS-Setup-ENU.exe download.microsoft.com/download/*/SSMS-Setup-ESN.exe download.microsoft.com/download/*/SSMS-Setup-FRA.exe download.microsoft.com/download/*/SSMS-Setup-ITA.exe download.microsoft.com/download/*/SSMS-Setup-JPN.exe download.microsoft.com/download/*/SSMS-Setup-KOR.exe download.microsoft.com/download/*/SSMS-Setup-PTB.exe download.microsoft.com/download/*/SSMS-Setup-RUS.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-saracmd-https" "download.microsoft.com/download/*/SaRACmd_17_01_3954_000.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-safetyscanner-https" "definitionupdates.microsoft.com/packages/content/msert.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-screenrecorder-https" "github.com/microsoft/screenrecorder/releases/download/*/irexplorer-x64.zip objects.githubusercontent.com/github-production-release-asset-2e65be/791996359/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-securitycompliancetoolkit-lgpo-https" "download.microsoft.com/download/8/5/c/*/LGPO.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-securitycompliancetoolkit-policyanalyzer-https" "download.microsoft.com/download/8/5/c/*/PolicyAnalyzer.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-securitycompliancetoolkit-setobjectsecurity-https" "download.microsoft.com/download/8/5/c/*/SetObjectSecurity.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-servicefabricruntime-https" "download.microsoft.com/download/b/8/a/*/MicrosoftServiceFabric.*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-servicefabricsdk-https" "download.microsoft.com/download/b/8/a/*/MicrosoftServiceFabricSDK.*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-setupdiag-https" "download.microsoft.com/download/1/1/1/*/SetupDiag.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-smartdump-https" "github.com/microsoft/SmartDump/releases/download/*.13/SmartDump_*.13.zip objects.githubusercontent.com/github-production-release-asset-2e65be/370983368/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sqlpackage-https" "download.microsoft.com/download/*/sqlpackage-win-x64-en-* go.microsoft.com/fwlink/" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-surfaceapp-https" "download.microsoft.com/download/*/Microsoft.SurfaceHub_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-surfacehubrecoverytool-https" "download.microsoft.com/download/8/3/f/*/SurfaceHub_Recovery_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-autologon-https" "download.sysinternals.com/files/AutoLogon.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-autoruns-https" "download.sysinternals.com/files/Autoruns.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-bginfo-https" "download.sysinternals.com/files/BGInfo.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-ctrl2cap-https" "download.sysinternals.com/files/Ctrl2Cap.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-debugview-https" "download.sysinternals.com/files/DebugView.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-desktops-https" "download.sysinternals.com/files/Desktops.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-findlinks-https" "download.sysinternals.com/files/FindLinks.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-handle-https" "download.sysinternals.com/files/Handle.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-movefile-https" "download.sysinternals.com/files/pendmoves.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-pendmoves-https" "download.sysinternals.com/files/pendmoves.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-processexplorer-https" "download.sysinternals.com/files/ProcessExplorer.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-processmonitor-https" "download.sysinternals.com/files/ProcessMonitor.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-rammap-https" "download.sysinternals.com/files/RAMMap.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-rdcman-https" "download.sysinternals.com/files/RDCMan.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-regjump-https" "download.sysinternals.com/files/regjump.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-sdelete-https" "download.sysinternals.com/files/SDelete.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-sigcheck-https" "download.sysinternals.com/files/Sigcheck.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-strings-https" "download.sysinternals.com/files/Strings.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-sysmon-https" "download.sysinternals.com/files/Sysmon.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-tcpview-https" "download.sysinternals.com/files/TCPView.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-vmmap-https" "download.sysinternals.com/files/VMMap.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-whois-https" "download.sysinternals.com/files/WhoIs.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-sysinternals-zoomit-https" "download.sysinternals.com/files/ZoomIt.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-teammate-https" "github.com/microsoft/TeamMate/releases/download/*%2BBranch.main.Sha.ab90a2e5561ad31cb29d990851429a88da413080/Microsoft.Tools.TeamMate.msi objects.githubusercontent.com/github-production-release-asset-2e65be/380329493/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-teams-https" "installer.teams.static.microsoft/production-windows-arm64/*/MSTeams-arm64.msix installer.teams.static.microsoft/production-windows-x64/*/MSTeams-x64.msix installer.teams.static.microsoft/production-windows-x86/*/MSTeams-x86.msix" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-teamstxndi-https" "teams.microsoft.com/core-calling-lib/*/ndi-win-x64_vs2022-crtdynamic-release.msix" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-timetraveldebugging-https" "windbg.download.prss.microsoft.com/dbazure/prod/1-11-584-0/TTD.msixbundle" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-tokenizer-https" "github.com/microsoft/Tokenizer/releases/download/*/Tokenizer.zip objects.githubusercontent.com/github-production-release-asset-2e65be/620176227/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-updateassistant-https" "download.microsoft.com/download/4/8/3/*/Windows10Upgrade9252.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vclibs-14-https" "github.com/microsoft/winget-cli/releases/download/*/DesktopAppInstaller_Dependencies.zip objects.githubusercontent.com/github-production-release-asset-2e65be/197275130/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vclibs-desktop-14-https" "github.com/microsoft/winget-cli/releases/download/*/DesktopAppInstaller_Dependencies.zip objects.githubusercontent.com/github-production-release-asset-2e65be/197275130/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vcredist-2015+-arm64-https" "download.visualstudio.microsoft.com/download/pr/*/VC_redist.arm64.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vcredist-2015+-x64-https" "download.visualstudio.microsoft.com/download/pr/*/VC_redist.x64.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vcredist-2015+-x86-https" "download.visualstudio.microsoft.com/download/pr/*/VC_redist.x86.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vsdotnetlogcollect-https" "download.microsoft.com/download/8/3/4/*/Collect.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vsixbootstrapper-https" "github.com/microsoft/vsixbootstrapper/releases/download/*/VSIXBootstrapper.exe objects.githubusercontent.com/github-production-release-asset-2e65be/80772789/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-vstor-https" "download.microsoft.com/download/5/d/2/*/vstor_redist.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visioviewer-https" "download.microsoft.com/download/D/B/7/*/visioviewer_4339-1001_x64_en-us.exe download.microsoft.com/download/D/B/7/*/visioviewer_4339-1001_x86_en-us.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-buildtools-https" "download.visualstudio.microsoft.com/download/pr/*/vs_BuildTools.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-enterprise-https" "download.visualstudio.microsoft.com/download/pr/*/vs_Enterprise.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-professional-https" "download.visualstudio.microsoft.com/download/pr/*/vs_Professional.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-2022-remotetools-https" "download.visualstudio.microsoft.com/download/pr/*/VS_RemoteTools.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-configfinder-https" "github.com/microsoft/VSConfigFinder/releases/download/*/VSConfigFinder.exe objects.githubusercontent.com/github-production-release-asset-2e65be/599725617/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-extensions-typescript-https" "typescriptteam.gallerycdn.vsassets.io/extensions/typescriptteam/typescript-43/4.3/*/TypeScript_SDK_4.3.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualstudio-locator-https" "github.com/microsoft/vswhere/releases/download/*/vswhere.exe objects.githubusercontent.com/github-production-release-asset-2e65be/78482723/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-visualtruetype-https" "github.com/microsoft/VisualTrueType/releases/download/*/release_binary.zip objects.githubusercontent.com/github-production-release-asset-2e65be/371173069/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-wsl-https" "github.com/microsoft/WSL/releases/download/*/Microsoft.WSL_* github.com/microsoft/WSL/releases/download/*/wsl.* objects.githubusercontent.com/github-production-release-asset-2e65be/55626935/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-wassette-https" "github.com/microsoft/wassette/releases/download/*/wassette_* objects.githubusercontent.com/github-production-release-asset-2e65be/1020008528/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-win32contentpreptool-https" "codeload.github.com/microsoft/Microsoft-Win32-Content-Prep-Tool/zip/refs/tags/* github.com/microsoft/Microsoft-Win32-Content-Prep-Tool/archive/refs/tags/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-winappcli-https" "github.com/microsoft/winappCli/releases/download/*/winappcli_arm64.msix github.com/microsoft/winappCli/releases/download/*/winappcli_x64.msix objects.githubusercontent.com/github-production-release-asset-2e65be/1029302123/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windbg-https" "windbg.download.prss.microsoft.com/dbazure/prod/1-2603-20001-0/windbg.msixbundle" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsadk-https" "download.microsoft.com/download/*/adk/adksetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsadmincenter-https" "download.microsoft.com/download/*/WindowsAdminCenter2511.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsapp-https" "res.cdn.office.net/remote-desktop-windows-client/*/WindowsApp_arm64_Release_* res.cdn.office.net/remote-desktop-windows-client/*/WindowsApp_x64_Release_* res.cdn.office.net/remote-desktop-windows-client/*/WindowsApp_x86_Release_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsappruntime-1-7-https" "aka.ms/windowsappsdk/1.7/*/windowsappruntimeinstall-arm64.exe aka.ms/windowsappsdk/1.7/*/windowsappruntimeinstall-x64.exe aka.ms/windowsappsdk/1.7/*/windowsappruntimeinstall-x86.exe download.microsoft.com/download/*/WindowsAppRuntimeInstall-arm64.exe download.microsoft.com/download/*/WindowsAppRuntimeInstall-x64.exe download.microsoft.com/download/*/WindowsAppRuntimeInstall-x86.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsappruntime-1-8-https" "download.microsoft.com/download/*/Microsoft.WindowsAppRuntime.Redist.* download.microsoft.com/download/*/WindowsAppRuntimeInstall-arm64.exe download.microsoft.com/download/*/WindowsAppRuntimeInstall-x64.exe download.microsoft.com/download/*/WindowsAppRuntimeInstall-x86.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsapplicationdriver-https" "github.com/microsoft/WinAppDriver/releases/download/*/WindowsApplicationDriver_* objects.githubusercontent.com/github-production-release-asset-2e65be/54308403/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowscloudioprotectiondriver-https" "res-1.cdn.office.net/assets/wcio-protection/msi/*/wcio_protection_driver_installer_arm_* res-1.cdn.office.net/assets/wcio-protection/msi/*/wcio_protection_driver_installer_x64_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsdevicerecoverytool-https" "download.microsoft.com/download/*/wdrt-hl1.zip" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsinstallationassistant-https" "download.microsoft.com/download/*/Windows11InstallationAssistant.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsmidiservicessdk-https" "github.com/microsoft/MIDI/releases/download/rc-1/Windows.MIDI.Services.SDK.Runtime.and.Tools.* objects.githubusercontent.com/github-production-release-asset-2e65be/495959471/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowspchealthcheck-https" "download.microsoft.com/download/b/2/9/*/4.0/x64/WindowsPCHealthCheckSetup.msi download.microsoft.com/download/b/2/9/*/4.0/x86/WindowsPCHealthCheckSetup.msi" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowssdk-10-0-22621-https" "download.microsoft.com/download/3/b/d/*/windowssdk/winsdksetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowssdk-10-0-26100-https" "download.microsoft.com/download/*/KIT_BUNDLE_WINDOWSSDK_MEDIACREATION/winsdksetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowssdk-10-0-28000-https" "download.microsoft.com/download/*/KIT_BUNDLE_WINDOWSSDK_MEDIACREATION/winsdksetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsterminal-https" "github.com/microsoft/terminal/releases/download/*/Microsoft.WindowsTerminal_* objects.githubusercontent.com/github-production-release-asset-2e65be/100060912/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsvirtualdesktopagent-https" "go.microsoft.com/fwlink/ query.prod.cms.rt.microsoft.com/cms/api/am/binary/RWrmXv res.cdn.office.net/s01-remote-desktop-agent/*/Microsoft.RDInfra.RDAgent.Installer-x64-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowsvirtualdesktopbootloader-https" "query.prod.cms.rt.microsoft.com/cms/api/am/binary/RWrxrH res.cdn.office.net/s01-remote-desktop-agent/*/Microsoft.RDInfra.RDAgentBootLoader.Installer-x64-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowswdk-10-0-22621-https" "download.microsoft.com/download/7/b/f/*/wdk/wdksetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-windowswdk-10-0-26100-https" "download.microsoft.com/download/*/KIT_BUNDLE_WDK_MEDIACREATION/wdksetup.exe" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-xmlnotepad-https" "github.com/microsoft/XmlNotepad/releases/download/*/XmlNotepadPackage_* github.com/microsoft/XmlNotepad/releases/download/*/XmlNotepadSetup.zip objects.githubusercontent.com/github-production-release-asset-2e65be/57244664/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-bitsmanager-https" "github.com/microsoft/BITS-Manager/releases/download/*.12/BITSManager.msi objects.githubusercontent.com/github-production-release-asset-2e65be/157477886/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-err-https" "download.microsoft.com/download/4/3/2/*/Err_*/Err_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-etl2pcapng-https" "github.com/microsoft/etl2pcapng/releases/download/*/etl2pcapng.exe objects.githubusercontent.com/github-production-release-asset-2e65be/208918651/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-quicreach-https" "github.com/microsoft/quicreach/releases/download/*/quicreach.msi objects.githubusercontent.com/github-production-release-asset-2e65be/477368453/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-ms-winfile-https" "github.com/microsoft/winfile/releases/download/*/Winfile_* objects.githubusercontent.com/github-production-release-asset-2e65be/127789081/*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-telerik-fiddler-classic-https" "downloads.getfiddler.com/fiddler-classic/FiddlerSetup.*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wiresharkfoundation-stratoshark-https" "1.na.dl.wireshark.org/win64/Stratoshark-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wiresharkfoundation-wireshark-https" "2.na.dl.wireshark.org/win64/all-versions/Wireshark-*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-infra-https" "cdimages.ubuntu.com wslstorestorage.blob.core.windows.net" "targetFqdns"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-20-04-https" "aka.ms/wslubuntu2004 wslstorestorage.blob.core.windows.net/wslblob/CanonicalGroupLimited.UbuntuonWindows_*" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-22-04-https" "aka.ms/wslubuntu2204 wslstorestorage.blob.core.windows.net/wslblob/Ubuntu2204-221101.AppxBundle" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-24-04-https" "cdimages.ubuntu.com/ubuntu-wsl/noble/daily-live/current/noble-wsl-amd64.wsl" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
...
rule_exists_and_matches "mirror-to-wsl-ubuntu-26-04-https" "cdimages.ubuntu.com/ubuntu-wsl/daily-live/current/resolute-wsl-amd64.wsl" "targetUrls"
RC=$?
if [ $RC -eq 0 ]; then
  echo -e "${CYAN}⏭️  跳過（已存在且相同）${NC}"
  SKIPPED=$((SKIPPED + 1))
