...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/microsoft/apm/releases/download/v0.12.1/apm-windows-x86_64.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
PKG_DIR="$DOWNLOAD_DIR/Microsoft/AccessDatabaseEngine2016"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.AccessDatabaseEngine2016 v16.0.5044.1000"

FILEPATH="$PKG_DIR/accessdatabaseengine.exe"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: accessdatabaseengine.exe (x86)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: accessdatabaseengine.exe (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/3/5/c/35c84c36-661a-44e6-9324-8786b8dbe231/accessdatabaseengine.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: accessdatabaseengine.exe"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/accessdatabaseengine_X64.exe"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: accessdatabaseengine_X64.exe (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: accessdatabaseengine_X64.exe (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/3/5/c/35c84c36-661a-44e6-9324-8786b8dbe231/accessdatabaseengine_X64.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: accessdatabaseengine_X64.exe"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
PKG_DIR="$DOWNLOAD_DIR/Microsoft/AdvertisingEditor"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.AdvertisingEditor v11.31.21766"

FILEPATH="$PKG_DIR/MicrosoftAdvertisingEditor.exe"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: MicrosoftAdvertisingEditor.exe (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: MicrosoftAdvertisingEditor.exe (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://prod.editor.ads.microsoft.com/download/production-pc/c/MicrosoftAdvertisingEditor.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: MicrosoftAdvertisingEditor.exe"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/Azure/azure-dev/releases/download/azure-dev-cli_1.24.3/azd-windows-amd64.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
# === Microsoft.AzureCLI v2.86.0 ===
PKG_DIR="$DOWNLOAD_DIR/Microsoft/AzureCLI"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.AzureCLI v2.86.0"

FILEPATH="$PKG_DIR/azure-cli-2.86.0.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: azure-cli-2.86.0.msi (x86)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: azure-cli-2.86.0.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://azcliprod.blob.core.windows.net/msi/azure-cli-2.86.0.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: azure-cli-2.86.0.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/azure-cli-2.86.0-x64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: azure-cli-2.86.0-x64.msi (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: azure-cli-2.86.0-x64.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://azcliprod.blob.core.windows.net/msi/azure-cli-2.86.0-x64.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: azure-cli-2.86.0-x64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
# === Microsoft.Bicep v0.43.1 ===
PKG_DIR="$DOWNLOAD_DIR/Microsoft/Bicep"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.Bicep v0.43.1"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/Azure/bicep/releases/download/v0.43.1/bicep-win-x64.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/Azure/bicep/releases/download/v0.43.1/bicep-win-arm64.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/Azure/bicep/releases/download/v0.43.1/bicep-setup-win-x64.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
PKG_DIR="$DOWNLOAD_DIR/Microsoft/DotNet/Native/Runtime"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.DotNet.Native.Runtime v2.2.28604.0"

FILEPATH="$PKG_DIR/Dependencies.zip"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: Dependencies.zip (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: Dependencies.zip (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://github.com/microsoft/busiotools/releases/download/v2.8.0/Dependencies.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: Dependencies.zip"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.Edge v147.0.3912.98"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/cfe18d3c-476a-4463-94b4-351752d72059/MicrosoftEdgeEnterpriseX86.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/33a7f26a-babe-4cfd-aa52-de77616e2850/MicrosoftEdgeEnterpriseX64.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/5f4d4555-76af-4fcf-b620-090c8ba3da44/MicrosoftEdgeEnterpriseARM64.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.EdgeDriver v147.0.3912.98"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://msedgedriver.microsoft.com/147.0.3912.98/edgedriver_win32.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://msedgedriver.microsoft.com/147.0.3912.98/edgedriver_win64.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://msedgedriver.microsoft.com/147.0.3912.98/edgedriver_arm64.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
PKG_DIR="$DOWNLOAD_DIR/Microsoft/IIS/ApplicationRequestRouting"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.IIS.ApplicationRequestRouting v3.0.05311"

FILEPATH="$PKG_DIR/fwlink"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: fwlink (x86)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: fwlink (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://go.microsoft.com/fwlink/?LinkID=615135" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
FILEPATH="$PKG_DIR/fwlink"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: fwlink (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: fwlink (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://go.microsoft.com/fwlink/?LinkID=615136" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.OneDrive v26.063.0405.0002"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://oneclient.sfx.ms/Win/Installers/26.063.0405.0002/OneDriveSetup.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://oneclient.sfx.ms/Win/Installers/26.063.0405.0002/amd64/OneDriveSetup.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://oneclient.sfx.ms/Win/Installers/26.063.0405.0002/arm64/OneDriveSetup.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.OpenJDK.11 v11.0.31.11"

FILEPATH="$PKG_DIR/microsoft-JDK-11.0.31-windows-x64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-11.0.31-windows-x64.msi (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-11.0.31-windows-x64.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-11.0.31-windows-x64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-11.0.31-windows-x64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/microsoft-JDK-11.0.31-windows-aarch64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-11.0.31-windows-aarch64.msi (arm64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-11.0.31-windows-aarch64.msi (arm64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-11.0.31-windows-aarch64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-11.0.31-windows-aarch64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

# === Microsoft.OpenJDK.17 v17.0.19.10 ===
PKG_DIR="$DOWNLOAD_DIR/Microsoft/OpenJDK/17"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.OpenJDK.17 v17.0.19.10"

FILEPATH="$PKG_DIR/microsoft-JDK-17.0.19-windows-x64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-17.0.19-windows-x64.msi (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-17.0.19-windows-x64.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-17.0.19-windows-x64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-17.0.19-windows-x64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/microsoft-JDK-17.0.19-windows-aarch64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-17.0.19-windows-aarch64.msi (arm64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-17.0.19-windows-aarch64.msi (arm64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-17.0.19-windows-aarch64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-17.0.19-windows-aarch64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

# === Microsoft.OpenJDK.21 v21.0.11.10 ===
PKG_DIR="$DOWNLOAD_DIR/Microsoft/OpenJDK/21"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.OpenJDK.21 v21.0.11.10"

FILEPATH="$PKG_DIR/microsoft-JDK-21.0.11-windows-x64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-21.0.11-windows-x64.msi (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-21.0.11-windows-x64.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-21.0.11-windows-x64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-21.0.11-windows-x64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/microsoft-JDK-21.0.11-windows-aarch64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-21.0.11-windows-aarch64.msi (arm64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-21.0.11-windows-aarch64.msi (arm64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-21.0.11-windows-aarch64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-21.0.11-windows-aarch64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.OpenJDK.25 v25.0.3.9"

FILEPATH="$PKG_DIR/microsoft-JDK-25.0.3-windows-x64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-25.0.3-windows-x64.msi (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-25.0.3-windows-x64.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-25.0.3-windows-x64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-25.0.3-windows-x64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/microsoft-JDK-25.0.3-windows-aarch64.msi"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: microsoft-JDK-25.0.3-windows-aarch64.msi (arm64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: microsoft-JDK-25.0.3-windows-aarch64.msi (arm64/default)"
  if curl -fSL -o "$FILEPATH" "https://aka.ms/download-JDK/microsoft-JDK-25.0.3-windows-aarch64.msi#winget" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: microsoft-JDK-25.0.3-windows-aarch64.msi"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.Teams v26093.415.4620.1935"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://installer.teams.static.microsoft/production-windows-x86/26093.415.4620.1935/MSTeams-x86.msix" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://installer.teams.static.microsoft/production-windows-x64/26093.415.4620.1935/MSTeams-x64.msix" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://installer.teams.static.microsoft/production-windows-arm64/26093.415.4620.1935/MSTeams-arm64.msix" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.WinAppCli v0.3.1"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/microsoft/winappCli/releases/download/v0.3.1/winappcli_x64.msix" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://github.com/microsoft/winappCli/releases/download/v0.3.1/winappcli_arm64.msix" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.WindowsAppRuntime.1.8 v8000.836.2153.0"

FILEPATH="$PKG_DIR/Microsoft.WindowsAppRuntime.Redist.1.8.260416003.zip"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: Microsoft.WindowsAppRuntime.Redist.1.8.260416003.zip (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: Microsoft.WindowsAppRuntime.Redist.1.8.260416003.zip (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/ec6e81ec-4b72-459e-afa3-0ff5699f831b/Microsoft.WindowsAppRuntime.Redist.1.8.260416003.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: Microsoft.WindowsAppRuntime.Redist.1.8.260416003.zip"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: WindowsAppRuntimeInstall-x64.exe (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/1c9cc7e4-4453-4ed5-97bf-9347457fa09b/WindowsAppRuntimeInstall-x64.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: WindowsAppRuntimeInstall-arm64.exe (arm64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/22ba9cfe-9d66-424e-b2de-0e2d9090e777/WindowsAppRuntimeInstall-arm64.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: WindowsAppRuntimeInstall-x86.exe (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/def0fe17-e9f2-41e8-9b35-c3e93f2c9da5/WindowsAppRuntimeInstall-x86.exe" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
PKG_DIR="$DOWNLOAD_DIR/Microsoft/eBPFforWindows"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.eBPFforWindows v1.1.0"

FILEPATH="$PKG_DIR/Build-native-only.NativeOnlyRelease.x64.zip"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: Build-native-only.NativeOnlyRelease.x64.zip (x64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: Build-native-only.NativeOnlyRelease.x64.zip (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://github.com/microsoft/ebpf-for-windows/releases/download/Release-v1.1.0/Build-native-only.NativeOnlyRelease.x64.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: Build-native-only.NativeOnlyRelease.x64.zip"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi

FILEPATH="$PKG_DIR/Build-native-only.NativeOnlyRelease.arm64.zip"
if [ -f "$FILEPATH" ]; then
  echo "   ⏭️  已存在: Build-native-only.NativeOnlyRelease.arm64.zip (arm64)"
  SKIPPED=$((SKIPPED + 1))
else
  echo "   ⬇️  下載中: Build-native-only.NativeOnlyRelease.arm64.zip (arm64/default)"
  if curl -fSL -o "$FILEPATH" "https://github.com/microsoft/ebpf-for-windows/releases/download/Release-v1.1.0/Build-native-only.NativeOnlyRelease.arm64.zip" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
    echo "   ❌ 下載失敗: Build-native-only.NativeOnlyRelease.arm64.zip"
    FAILED=$((FAILED + 1))
    rm -f "$FILEPATH"
  fi
fi
...
# === Microsoft.msodbcsql.17 v17.11.1.1 ===
PKG_DIR="$DOWNLOAD_DIR/Microsoft/msodbcsql/17"
mkdir -p "$PKG_DIR"
echo "📦 Microsoft.msodbcsql.17 v17.11.1.1"
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/57ea94d1-a9bd-4ab7-990a-1c1c4e7a2ef8/x86/1033/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/d99fcd4f-548f-46e6-83d5-b9eb62b373d5/amd64/1033/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/62cf1733-644f-4e39-bfbb-f2a22e3a04b1/x86/1031/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/732b0a1e-304c-4eba-81fe-9e45ae38f3e3/amd64/1031/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/6e0b3d97-fe12-447c-b5da-a32e8ef81536/x86/3082/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/4f3f0ba4-b33d-4cdc-a833-cf443b2ef1a3/amd64/3082/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/26ecf933-f8e3-45ab-a11a-98e95677a5ca/x86/1036/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/ec01b851-6b13-4b08-812a-bd321405fe69/amd64/1036/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/7f550933-ae5d-4cbf-ac74-66677281af35/x86/1040/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/fd8ee424-7bae-463e-8f3a-435d49b33aa3/amd64/1040/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/389bad56-6590-477a-a6ba-99b46cc7e634/x86/1041/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/87e8b0bc-d558-4247-b115-f58d8f97fdc3/amd64/1041/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/0aaffa48-eec6-49fa-b964-5a3360e420d3/x86/1042/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/103a391b-2d9f-4212-ae41-9011be7a80e1/amd64/1042/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/f7e6f45a-eccf-4443-8fb6-96c37dc61bfb/x86/1046/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/44748bc5-fa9e-450f-8463-c761f9ddf6dd/amd64/1046/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/e31b4cea-bd03-4e06-aa1a-701417881b47/x86/1049/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/e1e07d39-6707-4c68-b1da-e3abf9704c5f/amd64/1049/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/d6a3132a-611f-45dc-905d-e80f55e9920c/x86/2052/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/3f00a8d7-2c56-4e74-bf1d-0a2ccca531d8/amd64/2052/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x86/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/501e7567-782d-47b0-8330-004610f0f12a/x86/1028/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
...
if [ -f "$FILEPATH" ]; then
  ...
  echo "   ⬇️  下載中: msodbcsql.msi (x64/default)"
  if curl -fSL -o "$FILEPATH" "https://download.microsoft.com/download/a41bcbe4-920e-40a9-bcb2-a45d2d5be1f6/amd64/1028/msodbcsql.msi" 2>/dev/null; then
    SIZE=$(du -h "$FILEPATH" | cut -f1)
    echo "   ✅ 完成: $SIZE"
    TOTAL=$((TOTAL + 1))
  else
